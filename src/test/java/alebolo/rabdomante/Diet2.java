...
public class Diet2 extends ExampleFD {
    ...
    */
	...
	public static void printLastSolution(org.jacop.examples.fd.Diet diet) {
    ...
    public static void main(String args[]) {
      ...
      org.jacop.examples.fd.Diet diet = new org.jacop.examples.fd.Diet();
      diet.model();
      ...
      diet = new org.jacop.examples.fd.Diet();
      diet.modelKnapsack();
